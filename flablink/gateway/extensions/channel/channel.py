...
from flablink.core.channel.channel import broadcast
from flablink.core.channel.base import Channels


await broadcast.publish(Channels.ACTIVITIES, "data or object here")
